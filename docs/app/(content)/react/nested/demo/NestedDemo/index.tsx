...
export default function NestedDemo() {
  return (
    <Panel group orientation="horizontal">
      <Panel
        initialSize="25%"
        className={`${styles.demoPanel} ${styles.panelLeft}`}
      >
        Left Panel
      ...
      <Panel group orientation="vertical" minSize="15%">
        ...
        <Panel group orientation="horizontal" minSize="15%">
          <Panel
            minSize="10%"
            className={`${styles.demoPanel} ${styles.panelBottomLeft}`}
          >
            Bottom Left
          ...
          <Panel
            minSize="10%"
            className={`${styles.demoPanel} ${styles.panelBottomRight}`}
          >
            Bottom Right
            <small>Flexible</small>
          </Panel>
      ...
      <Panel
        initialSize="22%"
        className={`${styles.demoPanel} ${styles.panelRight}`}
      >
        Right Panel
        <small>Fixed width</small>
      </Panel>
